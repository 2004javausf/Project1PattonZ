window.onload = function() {
    ...
    document.getElementById("formsubmit").addEventListener("click", this.submitGrade, false);
}
...
function jsonBuilder(){
    var elements=document.getElementById("uploadgrade").elements;
    var obj = {};
...
function submitGrade(){
    ...
    xhr.open("POST", `http://localhost:8080/TRMSProjectPattonZ/ULGrade`, true);
